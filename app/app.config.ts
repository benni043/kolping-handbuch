  ...
  ui: {
    breadcrumb: {
      ...
      variants: {
        active: {
          true: {
            link: "text-[#F18700] font-semibold",
          },
          false: {
      ...
      compoundVariants: [
        {
          ...
          variant: "solid",
          class:
            "text-inverted bg-primary hover:bg-primary/75 active:bg-primary/75 disabled:bg-gray-300 disabled:text-gray-500 aria-disabled:bg-gray-300 aria-disabled:text-gray-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary",
        },
