  ...
  <div>
    <UForm class="space-y-5">
      ...
      <UInput
        ...
        class="w-full"
      />
      <div v-if="usernameError" class="text-red-500 font-medium">
        {{ usernameError }}
      </div>
      ...
      <div v-if="passwordError" class="text-red-500 font-medium">
        {{ passwordError }}
      </div>
      ...
      <UInput
        ...
        class="w-full"
      />
      <div v-if="password2Error" class="text-red-500 font-medium">
        {{ password2Error }}
      </div>
